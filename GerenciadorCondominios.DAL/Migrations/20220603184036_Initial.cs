        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Placa = table.Column<string>(maxLength: 40, nullable: false),
                    UsuarioId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ServicosPredios",
                columns: table => new
                {
                    ServicoPredioId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServicoId = table.Column<int>(nullable: false),
                    DataExecusao = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicosPredios", x => x.ServicoPredioId);
                    table.ForeignKey(
                        name: "FK_ServicosPredios_Servicos_ServicoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ac9c8f14-840f-443a-a33f-38e9b51df29e", "9d2885da-790c-4299-90a5-fd153ecaaa9c", "Morador do Prédio", "Morador", "MORADOR" },
                    { "0db7f069-740e-4dff-96b8-4e0b9d4a2f58", "86def937-e117-4c92-af39-a1948e79e56c", "Sindico do Prédio", "Sindico", "SINDICO" },
                    { "7cc8f439-f0f7-4690-9170-e7b8cab628dd", "9b616ad3-5d18-492c-b69b-913ee4e312d9", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicosPredios_ServicoId",
                table: "ServicosPredios",
                column: "ServicoId");
